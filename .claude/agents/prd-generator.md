...
- **TailwindCSS v4** (기본 CSS 엔진) - 유틸리티 CSS 프레임워크
...
6. **최신 기술**: **반드시 현재 최신 버전** 명시 (Next.js 16.1.6, React 19 등)

## 🔧 기술 스택 선택 원칙

- **최신 버전 필수**: Next.js 16.1.6, React 19, TailwindCSS v4 등 최신 버전 사용
- **Next.js 16.1.6 기반**: 최신 App Router, React Compiler 지원, Turbopack 최적화
- **TailwindCSS v4**: 표준 CSS 엔진으로 안정적인 스타일링
...
- Next.js 16.1.6 (현재 최신버전)
- React 19 (현재 최신버전)
- TailwindCSS v4 (기본 CSS 엔진)
- 각 기술의 최신 버전 확인 후 명시
...
7. 필요 데이터 모델 최소화
8. **Next.js 16.1.6 기반** 최신 기술 스택 적용 (React Compiler, Turbopack 포함)
9. **정합성 검증 체크리스트 실행**
10. 템플릿 형식으로 출력
